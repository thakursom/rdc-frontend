...
function DashboardComponent() {
    ...
    const [youtubeDashboardData, setYoutubeDashboardData] = useState(null);

    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                setLoading(true);
                const [audioRes, youtubeRes] = await Promise.all([
                    apiRequest("/audio-streaming-dashboard", "GET", null, true),
                    apiRequest("/youtube-dashboard", "GET", null, true)
                ]);
                console.log("audioRes", audioRes);
                console.log("youtubeRes", youtubeRes);

                if (audioRes?.success) {
                    setDashboardData(audioRes.data.data);
                }

                if (youtubeRes?.success) {
                    setYoutubeDashboardData(youtubeRes.data.data);
                }
            } catch (err) {
    ...
    const audioDateRange = getLast12MonthsRange(dashboardData);
    const youtubeDateRange = getLast12MonthsRange(youtubeDashboardData);



    if (!dashboardData && !youtubeDashboardData && !loading) {
        return <div className="text-center py-10">No data available</div>;
    }
    const data = dashboardData || {};
    const youtubeData = youtubeDashboardData || {};
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child parot-cl">
                                                        <div className="dash-card">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Total Revenue</p>
                                                                <h6>{Number(youtubeData?.overview?.totalRevenue || 0).toLocaleString()}</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child navy-cl">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Release</p>
                                                                <h6>{youtubeData?.overview?.topRelease?.release || 'N/A'}</h6>
                                                                <span>{Number(youtubeData?.overview?.topRelease?.revenue || 0).toLocaleString()}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child orange-dark">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Artist</p>
                                                                <h6>{youtubeData?.overview?.topArtist?.artist || 'N/A'}</h6>
                                                                <span>{Number(youtubeData?.overview?.topArtist?.revenue || 0).toLocaleString()}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child yellow-dark">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Track</p>
                                                                <h6>{youtubeData?.overview?.topTrack?.track || 'N/A'}</h6>
                                                                <span>{Number(youtubeData?.overview?.topTrack?.revenue || 0).toLocaleString()}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                {loading ? (
                                                    ...
                                                    <GrowthChart revenueByMonthData={youtubeData?.monthlyRevenue} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <PlateFormShare data={youtubeData?.platformShare} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <RevenueStackedArea revenueData={youtubeData?.revenueByMonthPlatform} />
                                                )}
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <MusicStreamsChart musicData={youtubeData?.yearlyStreams[0]?.data} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child1">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                {loading ? (
                                                    ...
                                                    <TerritoryRevenue territoryData={youtubeData?.territoryRevenue} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                        <div className="stem-child parot-cl">
                                                            <div className="dash-card ">
                                                                ...
                                                                <div className="dash-content">
                                                                    <p>Total Stream</p>
                                                                    <h6>{youtubeData?.overview?.totalStreams || 0}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="dash-charts stem-child">
                                                ...
                                                <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                    ...
                                                    {loading ? (
                                                        ...
                                                        <WeeklyStreamChart weeklyData={youtubeData?.weeklyStreams[0]?.data} />
                                                    )}
                                                </div>
                                            ...
                                            <div className="dash-charts stem-child">
                                                ...
                                                <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                    ...
                                                    {loading ? (
                                                        ...
                                                        <MusicStreamComparisonChart comparisonData={youtubeData?.musicStreamComparison[0]} />
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="dash-charts stem-child">
                                                ...
                                                <div className="chart-container mb-3" style={{ position: "relative", height: "450px" }}>
                                                    ...
                                                    {loading ? (
                                                        ...
                                                        <StreamingTrendsOverTimeChart trendsData={youtubeData?.streamingTrends[0]} />
                                                    )}
                                                </div>
                                                <p>Streams (Millions)</p>
                                            </div>
