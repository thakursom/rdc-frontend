...
function DashboardComponent() {
    ...
    const [revenueByMonthPlatform, setRevenueByMonthPlatform] = useState([]);
    const [yearlyStreamData, setYearlyStreamData] = useState([]);
    const [territoryRevenueData, setTerritoryRevenueData] = useState([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const [totalRevenueRes, revenueByMonth, platformRes, revenueByMonthPlat, yearlyStreams, territoryRevenue] = await Promise.all([
                    apiRequest("/total-revenue", "GET", null, true),
                    apiRequest("/revenue-by-month", "GET", null, true),
                    apiRequest("/platform-share", "GET", null, true),
                    apiRequest("/revenue-by-month-stacked", "GET", null, true),
                    apiRequest("/yearly-streams", "GET", null, true),
                    apiRequest("/territory-revenue", "GET", null, true)
                ]);

                // Total revenue
                if (totalRevenueRes?.success) {
                    setDashboardData(totalRevenueRes?.data?.data || {});
                }

                // revenueByMonth
                if (revenueByMonth?.success) {
                    setRevenueByMonth(revenueByMonth?.data?.data || {});
                }

                // Platform
                if (platformRes?.success) {
                    setPlatformShare(platformRes?.data?.data || []);
                }

                // RevenueByMonthPlat
                if (revenueByMonthPlat?.success) {
                    setRevenueByMonthPlatform(revenueByMonthPlat?.data?.data || [])
                }

                // YearlyStreams
                if (yearlyStreams?.success) {
                    setYearlyStreamData(yearlyStreams?.data?.data || [])
                }

                // territoryRevenue
                if (territoryRevenue?.success) {
                    setTerritoryRevenueData(territoryRevenue?.data?.data || [])
                }
    ...
    const getLast12MonthsRange = () => {
        const items = revenueByMonthPlatform || [];
    ...
    console.log("getLast12MonthsRange", getLast12MonthsRange());
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child navy-cl">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Release</p>
                                                                <h6> {dashboardData?.topRelease?.release || 'N/A'}</h6>
                                                                <span>${dashboardData?.topRelease?.revenue.toFixed(2) || 'N/A'}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child orange-dark">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Artist</p>
                                                                <h6>{dashboardData?.topArtist?.artist || 'N/A'}</h6>
                                                                <span>${dashboardData?.topArtist?.revenue.toFixed(2) || 'N/A'}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 col-stem">
                                                    <div className="stem-child yellow-dark">
                                                        <div className="dash-card ">
                                                            ...
                                                            <div className="dash-content">
                                                                <p>Top Track</p>
                                                                <h6>{dashboardData?.topTrack?.track || 'N/A'}</h6>
                                                                <span>${dashboardData?.topTrack?.revenue.toFixed(2) || 'N/A'}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                {loading ? (
                                                    ...
                                                    <GrowthChart revenueByMonthData={revenueByMonth} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <PlateFormShare data={platformShare} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <RevenueStackedArea revenueData={revenueByMonthPlatform} />
                                                )}
                                        ...
                                        <div className="dash-charts stem-child">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                ...
                                                {loading ? (
                                                    ...
                                                    <MusicStreamsChart musicData={yearlyStreamData} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="dash-charts stem-child1">
                                            ...
                                            <div className="main-chartbox" style={{ position: "relative", height: "400px" }}>
                                                {loading ? (
                                                    ...
                                                    <TerritoryRevenue territoryData={territoryRevenueData} />
                                                )}
                                            </div>
                                        </div>
                                    </div>
