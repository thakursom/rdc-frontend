    ...
    <section className={`rdc-sidebar ${sidebarOpen ? "active2" : ""}`} >
      <div className="sidebar-mainbox">
        ...
        <ul className="sidebar-menu">
          ...
          {(role === "Super Admin" || role === "Label" || role === "Manager") && (
            <li className="sidebar-item">
          ...
          {/* {(role === "Super Admin" || role === "Label" || role === "Sub Label" || role === "Manager") && (
            <li className="sidebar-item">
              ...
              >
                ...
                >
                  <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" stroke="#F88C65" />
                  <path d="M14 2v4a2 2 0 0 0 2 2h4" stroke="#F88C65" />
                  <path d="M10 9H8"  stroke="#F88C65"/>
                  <path d="M16 13H8" stroke="#F88C65" />
                  <path d="M16 17H8" stroke="#F88C65" />
                </svg>
                Statement
              </NavLink>
            </li>
